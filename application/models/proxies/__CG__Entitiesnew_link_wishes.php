 ...
 */
class new_link_wishes extends \Entities\new_link_wishes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getLink_ilook_user_id();
    }

    public function setLink_ilook_user_id($link_ilook_user_id)
    {
        $this->__load();
        return parent::setLink_ilook_user_id($link_ilook_user_id);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'duration_to_display', 'underlying_text', 'created_at', 'ilookUser', 'wallPost', 'link_ilook_user_id');
    }
