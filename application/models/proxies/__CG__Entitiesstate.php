 ...
 */
class state extends \Entities\state implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'status', 'code', 'ilookUser', 'job', 'city', 'savedSearch', 'countryRef');
    }
