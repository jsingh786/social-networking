 ...
 */
class admin_activity_log extends \Entities\admin_activity_log implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'module', 'created_at', 'ilookUser', 'admin');
    }
