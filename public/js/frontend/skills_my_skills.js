$(document).ready(function(){
	...
	$("div.showskills").click(function(){
		...
		if($('div#skill_'+$(this).attr("skill")+':visible').length==0)
		{
			...
			//showSupportersForSkill(skill_id);
		}
		else
		{
	...
	/*// within ilook tab
	$("a#within_ilook").click(function(){
		$(this).addClass('selected_within_ilook');
		$("div.within-ilook-info-accord-content").show();
		$("div.within-links-info-accord-content").hide();
		$("a#within_links").removeClass('selected_within_links');
		
	});
	
	// within links  tab
	$("a#within_links").click(function(){
		$(this).addClass('selected_within_links');
		$("div.within-links-info-accord-content").show();
		$("div.within-ilook-info-accord-content").hide();
		$("a#within_ilook").removeClass('selected_within_ilook');
...
/**
 * Function to show supporters for a skill
 * @Param: integer skill_id, Id of a skill 
 * Author: sjaiswal
 * Version: 1.0
*/
function showSupportersForSkill(skill_id)
{
	 //show loading image
